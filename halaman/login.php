            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form action="" method="POST" role="form text-left">
                  <div class="mb-3">
                    <input name="nis" type="text" class="form-control" placeholder="Masukkan NIS anda..." aria-label="NIS" aria-describedby="email-addon">
                  </div>
                  ...
                  <div class="text-center">
                    <button name="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Masuk</button>
                  </div>
